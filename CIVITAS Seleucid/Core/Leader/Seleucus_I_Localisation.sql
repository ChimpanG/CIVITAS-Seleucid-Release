...
-----------------------------------------------	
	...
	("LOC_LEADER_CVS_SELEUCUS_I_NAME",  	"Seleucus I"	),
	
-----------------------------------------------
-- UA
-----------------------------------------------	

	("LOC_TRAIT_LEADER_CVS_SELEUCUS_I_UA_NAME",  	"Wars of the Diadochi"	),
	("LOC_TRAIT_LEADER_CVS_SELEUCUS_I_UA_DESCRIPTION",		
	"Encampment Buildings provide +1 [ICON_Amenities] Amenity and [ICON_GreatGeneral] Great Generals can use their retirement ability an additional time. Gains access to the Elephantarchia unique unit."),

	-- Great Person Replacement for Sun Tzu
	("LOC_GREAT_PERSON_INDIVIDUAL_CVS_SCIPIO_AFRICANUS_NAME",  	"Scipio Africanus"	),
	("LOC_GREATPERSON_CVS_SCIPIO_AFRICANUS_ACTIVE",  	"Instantly creates a Catapult unit"	),

-----------------------------------------------
-- UU
-----------------------------------------------

	("LOC_UNIT_CVS_SELEUCUS_I_UU_NAME",		"Elephantarchia"	),
	("LOC_UNIT_CVS_SELEUCUS_I_UU_DESCRIPTION",		
	"A heavy cavalry unit unique to Seleucid that must be purchased with [ICON_Gold] Gold and does not require maintenance. Has less [ICON_Movement] Movement than its Knight counterpart, but is stronger when defending. Deals full damage to city walls and earns [ICON_GreatGeneral] Great General Points from eliminating enemy units."	),

	("LOC_MODIFIER_CVS_SELEUCUS_I_UU_DEFENDING_DESCRIPTION",  	"+{1_Amount} Combat Strength when defending"	),

-----------------------------------------------
-- Agenda
-----------------------------------------------	

	("LOC_AGENDA_CVS_SELEUCUS_I_NAME",		"Hellenic Legacy"	),
	("LOC_AGENDA_CVS_SELEUCUS_I_DESCRIPTION", 	"Respects civilizations that have a high income that invest in military infrastructure. Thinks civilizations with large armies that avoid war are weak."	),
	("LOC_DIPLO_KUDO_LEADER_CVS_SELEUCUS_I_REASON_ANY",			  
	"(You have a high income and focus on military infrastructure.)"	),
	("LOC_DIPLO_MODIFIER_CVS_SELEUCUS_I_HAPPY",		
	"Seleucus I is pleased that you have many Barracks or Stables"	),
	("LOC_DIPLO_MODIFIER_CVS_SELEUCUS_I_HAPPY_2",		
	"Seleucus I is pleased that you have many Armories"	),
	("LOC_DIPLO_MODIFIER_CVS_SELEUCUS_I_HAPPY_3",		
	"Seleucus I is pleased that you have many Military Academies"	),
	("LOC_DIPLO_WARNING_LEADER_CVS_SELEUCUS_I_REASON_ANY",		  
	"(You have a large army but neglect warfare.)"	),
	("LOC_DIPLO_MODIFIER_CVS_SELEUCUS_I_UNHAPPY",		 
...
-- DOM
	("LOC_LOADING_INFO_LEADER_CVS_SELEUCUS_I",  	
...
-- FIRST MEET
	-- First AI Line
	("LOC_DIPLO_FIRST_MEET_LEADER_CVS_SELEUCUS_I_ANY",		
	...
	("LOC_DIPLO_FIRST_MEET_VISIT_RECIPIENT_LEADER_CVS_SELEUCUS_I_ANY",		
	"I'd like to extend a personal invitation to visit our city nearby."	),
	
	-- AI accepts human invitation
	("LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_CVS_SELEUCUS_I_ANY",		
	"Very well."	),
	
	-- AI invitation to exchange Capital Information
	("LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_CVS_SELEUCUS_I_ANY",		
...
-- GREETINGS	
	("LOC_DIPLO_GREETING_LEADER_CVS_SELEUCUS_I_ANY",		
	"Speak your mind."	),
	
-- DELEGATION
	-- AI Accepts
	("LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_CVS_SELEUCUS_I_ANY",		
	"Very well. They will be treated with the same respect you have shown me."	),
	
	-- AI Rejects
	("LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_CVS_SELEUCUS_I_ANY",		
	"I think not."	),
	
	-- AI Requests
	("LOC_DIPLO_DELEGATION_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",		
	"I have sent a delegation of minted Silver and coin as a gift. It should arrive with you shortly."	),
	
-- OPEN BORDERS
	-- AI accepts from human	
	("LOC_DIPLO_ACCEPT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_SELEUCUS_I_ANY",	                                   
	"Very well, but do not mistake my kindness for weakness."	),
	
	-- AI rejects from human	
	("LOC_DIPLO_REJECT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_SELEUCUS_I_ANY",  	                                   
	"I live by choice, not by chance and you have not given me enough reason to trust your intentions."	),
	
	-- AI requests from human	
	("LOC_DIPLO_OPEN_BORDERS_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",      	                                
	"My soldiers require safe passage through your lands. Can I count on you to provide this?"	),
	
-- DECLARE FRIENDSHIP

	-- AI accepts from human	
	("LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_SELEUCUS_I_ANY",   	                                   
	"We have accord."	),
	
	-- AI rejects from human	
	("LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_SELEUCUS_I_ANY",   	                                   
	...
	("LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",     	                                 
	...
	("LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",   	                                   
	"Excellent."	),
	
	-- Human rejects AI requests, AI responds	
	("LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",   	                                   
	"Arrogance seldom goes forgotten."	),

-- ALLIANCE

	-- AI Requests an alliance from human
	("LOC_DIPLO_MAKE_ALLIANCE_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",		
...
-- KUDOS & WARNINGS
	...
	("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_CVS_SELEUCUS_I_ANY",		
...
-- TRADE
	...
	-- AI Accepts Deal
	("LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",		
	"This will do."	),

	-- AI Rejects Deal
	("LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",		
	"I don't have time for games. Come back with a better offer, or don't come back at all."	),

-- DENOUNCE
	
	-- From Human
	("LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_CVS_SELEUCUS_I_ANY",		
	"It would serve you well not to underestimate an an old general in a profession where men usually die young."	),
	
	-- From AI
	("LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",		
	"A word to the wise, tempt not the more experienced warrior to draw his sword. (Denounces You)"	),
	
-- DOW
	
	-- Human Declares War
	("LOC_DIPLO_DECLARE_WAR_FROM_HUMAN_LEADER_CVS_SELEUCUS_I_ANY",		
	"So be it. To the dust we shall return."	),
	
	-- AI Declares War
	("LOC_DIPLO_DECLARE_WAR_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",		
...
-- MAKE PEACE
	...
	-- AI accepts from human
	("LOC_DIPLO_MAKE_PEACE_AI_ACCEPT_DEAL_LEADER_CVS_SELEUCUS_I_ANY",		
	"Great is the guilt of an unnecessary war. I can agree to this."	),
	
	-- AI refuses human
	("LOC_DIPLO_MAKE_PEACE_AI_REFUSE_DEAL_LEADER_CVS_SELEUCUS_I_ANY",		
	"Peace? Go stand in the ashes of your dead and ask them if peace is still an option. Their silence is your answer."	),
	
	-- AI requests from human
	("LOC_DIPLO_MAKE_PEACE_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",		
...
-- DEFEAT
	...
	-- AI is Defeated
	("LOC_DIPLO_DEFEAT_FROM_AI_LEADER_CVS_SELEUCUS_I_ANY",		
	...
	("LOC_DIPLO_DEFEAT_FROM_HUMAN_LEADER_CVS_SELEUCUS_I_ANY",		
	"You fought with honor and intelligence. I owe you my respect, for at last I have found a worthy successor to rule over my kingdom. I am finally at peace. Go ahead. Put me to the sword and finish this..."	),	
...
--------------------------------------------------------------------
	...
	("LOC_PEDIA_LEADERS_PAGE_CVS_SELEUCUS_I_QUOTE",		
	"Fight until you no longer need to introduce yourself."  ),
	
	("LOC_PEDIA_LEADERS_PAGE_CVS_SELEUCUS_I_TITLE",		
	"Seleucus I Nicator"),
	
	("LOC_PEDIA_LEADERS_PAGE_CVS_SELEUCUS_I_SUBTITLE",		
	"Basileus of the Seleucid Empire"),
	
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_SELEUCUS_I_CHAPTER_CAPSULE_BODY",		
	"Under Seleucus I, expansion through conquest is the order of the day, every day."),
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_SELEUCUS_I_CHAPTER_DETAILED_BODY",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_SELEUCUS_I_CHAPTER_HISTORY_PARA_1",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_SELEUCUS_I_CHAPTER_HISTORY_PARA_2",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_SELEUCUS_I_CHAPTER_HISTORY_PARA_3",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_SELEUCUS_I_CHAPTER_HISTORY_PARA_4",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_SELEUCUS_I_CHAPTER_HISTORY_PARA_5",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_SELEUCUS_I_CHAPTER_HISTORY_PARA_6",		
	...
	("LOC_PEDIA_UNITS_PAGE_UNIT_CVS_SELEUCUS_I_UU_CHAPTER_HISTORY_PARA_1",  	
	...
	("LOC_PEDIA_UNITS_PAGE_UNIT_CVS_SELEUCUS_I_UU_CHAPTER_HISTORY_PARA_2",  	
