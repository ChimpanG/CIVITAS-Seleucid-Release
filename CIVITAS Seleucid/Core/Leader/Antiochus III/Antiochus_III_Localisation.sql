...
-----------------------------------------------	
	...
	("LOC_LEADER_CVS_ANTIOCHUS_III_NAME",  "Antiochus III"	),
	
-----------------------------------------------
-- UA
-----------------------------------------------	

	("LOC_TRAIT_LEADER_CVS_ANTIOCHUS_III_UA_NAME",  "Strategoi"	),
	("LOC_TRAIT_LEADER_CVS_ANTIOCHUS_III_UA_DESCRIPTION",
	"May build the unique units of civilizations whose cities you've conquered. Allied city-states provide the [ICON_Amenities] Amenities of luxury resources they own that you do not."	),

	("LOC_TRAIT_LEADER_CVS_ANTIOCHUS_III_UA_XP1_DESCRIPTION",
	"May build the unique units of civilizations whose cities you've conquered, which provide their era score bonus upon being built for the first time. Allied city-states provide the [ICON_Amenities] Amenities of luxury resources they own that you do not."	),

	("LOC_BUILDING_CVS_ANTIOCHUS_III_UA_NAME",  "Seleucid Satrapy"	),
	("LOC_BUILDING_CVS_ANTIOCHUS_III_UA_DESCRIPTION",  "Allows empire-wide training of Unique Units of this City's previous owner."	),

-----------------------------------------------
-- Agenda
-----------------------------------------------	

	("LOC_AGENDA_CVS_ANTIOCHUS_III_NAME",						"Basileus Megas"	),
	("LOC_AGENDA_CVS_ANTIOCHUS_III_DESCRIPTION",				"Wants to amass the largest army and regards those with larger armies as a threat. Likes Civilizations that do not compete for City-State suzerainity."	),
	("LOC_DIPLO_KUDO_LEADER_CVS_ANTIOCHUS_III_REASON_ANY",		"(You are keeping the peace on his continent.)"	),
	("LOC_DIPLO_MODIFIER_CVS_ANTIOCHUS_III_HAPPY",				"Antiochus III is happy that you are keeping the peace on his continent"	),
	("LOC_DIPLO_WARNING_LEADER_CVS_ANTIOCHUS_III_REASON_ANY",	"(You have a large military.)"	),
	("LOC_DIPLO_MODIFIER_CVS_ANTIOCHUS_III_UNHAPPY",			"Antiochus III regards your military might as a threat."	),
		
-----------------------------------------------
-- DOM
-----------------------------------------------	

	("LOC_LOADING_INFO_LEADER_CVS_ANTIOCHUS_III",
...
-----------------------------------------------	
	...
	-- First AI Line (ANY)
	("LOC_DIPLO_FIRST_MEET_LEADER_CVS_ANTIOCHUS_III_ANY",
	...
	("LOC_DIPLO_FIRST_MEET_VISIT_RECIPIENT_LEADER_CVS_ANTIOCHUS_III_ANY",
	...
	("LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_CVS_ANTIOCHUS_III_ANY",
	"Of course."	),
	
	-- AI invitation to exchange Capital Information (ANY)
	("LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_CVS_ANTIOCHUS_III_ANY",
...
-----------------------------------------------	
	...
	-- (HAPPY)
	("LOC_DIPLO_GREETING_LEADER_CVS_ANTIOCHUS_III_HAPPY",
	"What can I do for you?"	),

	-- (UNHAPPY)
	("LOC_DIPLO_GREETING_LEADER_CVS_ANTIOCHUS_III_UNHAPPY",
	"Go on..."	),
...
-----------------------------------------------	
	...
	-- AI Accepts (ANY)
	("LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_CVS_ANTIOCHUS_III_ANY",
	"Of course. I will welcome your delegates personally."	),
	
	-- AI Rejects (ANY)
	("LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_CVS_ANTIOCHUS_III_ANY",
	"I cannot allow that at this time."	),
	
	-- AI Requests (ANY)
	("LOC_DIPLO_DELEGATION_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_ACCEPT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_ANTIOCHUS_III_ANY",
	"Of course, I see no reason not to."	),
	
	-- AI rejects from human (ANY)	
	("LOC_DIPLO_REJECT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_ANTIOCHUS_III_ANY",
	"Until I understand your intentions, I cannot allow this."	),
	
	-- AI requests from human (ANY)	
	("LOC_DIPLO_OPEN_BORDERS_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
...
-----------------------------------------------	
	...
	-- AI accepts from human (ANY)
	("LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_ANTIOCHUS_III_ANY",
	"A wise idea. Let the world know that we stand united as friends."	),
	
	-- AI rejects from human (ANY)	
	("LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_ANTIOCHUS_III_ANY",
	"I do not see a friend in you at this time. Perhaps later."	),
	
	-- AI Requests friendship from human (ANY)	
	("LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
	...
	("LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
	"Excellent."	),
	
	-- Human rejects AI requests, AI responds (ANY)	
	("LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
	"Pity."	),
...
-----------------------------------------------	
	...
	("LOC_DIPLO_MAKE_ALLIANCE_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
...
-----------------------------------------------	
	...
	-- AI Kudos (ANY)
	("LOC_DIPLO_KUDO_EXIT_LEADER_CVS_ANTIOCHUS_III_ANY",
	...
	-- AI Warnings (ANY)
	("LOC_DIPLO_WARNING_EXIT_LEADER_CVS_ANTIOCHUS_III_ANY",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_CVS_ANTIOCHUS_III_ANY",
	"I say this once, and once only. Remove your troops from borders."	),

	-- AI accepts player's warning for border troops warning
	("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_CVS_ANTIOCHUS_III_ANY",
	"I will remove them at once. Apologies for the confusion."	),
		
	-- AI rejects player's warning for border troops warning (ANY) ~ DECLARES WAR
	("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_CVS_ANTIOCHUS_III_ANY",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
	...
	("LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_CVS_ANTIOCHUS_III_ANY",
...
-----------------------------------------------	
	...
	-- AI Accepts Deal (ANY)
	("LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
	"I accept."	),
	
	-- AI Rejects Deal (Unhappy)
	("LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
	"I think not."	),
...
-----------------------------------------------	
	...
	-- From Human
	("LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_CVS_ANTIOCHUS_III_ANY",
	"I don't respond to threats. I make them, and you would be wise not to test my patience."	),
	
	-- From AI
	("LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
...
-----------------------------------------------	
	...
	-- Human Declares War
	("LOC_DIPLO_DECLARE_WAR_FROM_HUMAN_LEADER_CVS_ANTIOCHUS_III_ANY",
	"You are a fool. Know that this will be the last decision you will ever make."	),
	
	-- AI Declares War
	("LOC_DIPLO_DECLARE_WAR_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
...
-----------------------------------------------	
	...
	("LOC_DIPLO_MAKE_PEACE_AI_ACCEPT_DEAL_LEADER_CVS_ANTIOCHUS_III_ANY",
	"I would agree. Let us settle this with a truce."	),
	
	-- AI refuses human
	("LOC_DIPLO_MAKE_PEACE_AI_REFUSE_DEAL_LEADER_CVS_ANTIOCHUS_III_ANY",
	"I would not accept such humiliation."	),
	
	-- AI requests from human
	("LOC_DIPLO_MAKE_PEACE_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
...
-----------------------------------------------	
	...
	-- AI is Defeated
	("LOC_DIPLO_DEFEAT_FROM_AI_LEADER_CVS_ANTIOCHUS_III_ANY",
	...
	("LOC_DIPLO_DEFEAT_FROM_HUMAN_LEADER_CVS_ANTIOCHUS_III_ANY",
	"My armies, scattered to the winds. My people, displaced from their homes. I wish you nothing but a lifetime of suffering for what you have done."	),
...
--------------------------------------------------------------------
	...
	("LOC_PEDIA_LEADERS_PAGE_CVS_ANTIOCHUS_III_QUOTE",
	"Geography might keep one a neighbor, but it is fear that keeps their allegiance."  ),
	
	("LOC_PEDIA_LEADERS_PAGE_CVS_ANTIOCHUS_III_TITLE",
	"Antiochus III"),
	
	("LOC_PEDIA_LEADERS_PAGE_CVS_ANTIOCHUS_III_SUBTITLE",
	"Basileus Megas"	),
	
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANTIOCHUS_III_CHAPTER_CAPSULE_BODY",
	"A dynamic army is at its most dangerous under Antiochus III."),
	
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANTIOCHUS_III_CHAPTER_DETAILED_BODY",
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANTIOCHUS_III_CHAPTER_HISTORY_PARA_1",
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ANTIOCHUS_III_CHAPTER_HISTORY_PARA_2",
