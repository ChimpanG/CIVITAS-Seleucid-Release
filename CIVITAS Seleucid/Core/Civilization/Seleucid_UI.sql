...
VALUES	('MODTYPE_CVS_SELEUCID_UI_TRADE_YIELD_DOMESTIC',		'COLLECTION_OWNER',		'EFFECT_ADJUST_CITY_TRADE_ROUTE_YIELD_FOR_DOMESTIC'			),
...
INSERT INTO	ModifierArguments
		(ModifierId,											Name,			Value	)
SELECT	'MODIFIER_CVS_SELEUCID_UI_TRADE_I_'||BuildingType,		'YieldType',	'YIELD_FOOD'
FROM	Buildings WHERE	PrereqDistrict = 'DISTRICT_COMMERCIAL_HUB' AND TraitType IS NULL;
